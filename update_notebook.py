...
# Fix the bug with the tuple in cell 5
...
# Append new markdown for merging
nb['cells'].append({
   'cell_type': 'markdown',
   'metadata': {},
   'source': [
...
# Append new markdown for training
nb['cells'].append({
   'cell_type': 'markdown',
   'metadata': {},
   'source': [
